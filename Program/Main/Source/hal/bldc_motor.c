...
#define  BLDC_MOTOR_TDR_REG         TDR05
...
{
  //  if( (TOE1 & _0002_TAU_CH1_OUTPUT_ENABLE ) != 0 )
    if( (TOE0 & _0020_TAU_CH5_OUTPUT_ENABLE ) != 0 )
    {
        return TRUE;
    }
...
void UpdateBldcFeedbackFrequency(void)
{
